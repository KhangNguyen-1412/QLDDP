      ...
      <div className="flex flex-1">
        ...
        >
          ...
          <nav className="space-y-2">
            ...
            {userId &&
              userRole === 'admin' && ( // Điều hướng Admin
                <>
                  <div>
                    <button
        ...
        {/* Content Area */}
        <main
          className={`flex-1 p-4 transition-all duration-300 ease-in-out overflow-y-auto ${isSidebarOpen && window.innerWidth < 1024 ? 'sidebar-open-overlay' : ''}`}
        >
          {userId ? (
            renderSection()
          ) : (
